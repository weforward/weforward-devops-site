<template>
  <div class="wangguan_area">
    ...
    <div class="selbox">
      服务名：
      <SingleSelect :width='150' :items="serviceNameList" @select="changeName" :selectname='serviceName'></SingleSelect>
      <span style="margin-left: 3%;">服务编号：<SingleSelect :width='150' :items="serviceNoList" @select="changeNo"
                                                        :selectname='serviceNo'></SingleSelect></span>
    ...
    <div class="facts_boxs">
      <div style="margin-left: 10px;" :class="['query_button',{'is_sel':!isOnTime }] " @click="clickTime('onTime')">实时
      </div>
  ...
  methods: {
    freshEcharts() {
      ...
      if (!this.dateTime) {
        ...
        } else if (new Date(this.dateTime[1]) - new Date(this.dateTime[0]) <= 60000) {
