  ...
  <div class="project_area">
    <div class="query">
      <div class="query_input">
        <input ref="keywords" type="text" v-model="page.keywords" class="input" @keyup.enter='getProjectList'/>
        <el-button type="primary" size="small" class="ml-1" @click="getProjectList">查 询</el-button>
      </div>
      <div class="query_group">
        ...
        <el-button type="primary" size="small" class="ml-1" @click="addProject">
          + 添 加
        </el-button>
      </div>
    </div>
    ...
    <AddProject ref="addmodel" :obj="editProjectObj" :isshow="showCreate" @toggle="showCreate = !showCreate"
                @load="getProjectList"></AddProject>
